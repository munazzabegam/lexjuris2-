    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="row mb-4">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="article_details.php?id=<?php echo $article_id; ?>" class="btn btn-secondary">
            ...
            <div class="edit-article-form">
                ...
                <form action="actions/update_article.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="article_details.php?id=<?php echo $article_id; ?>" class="btn btn-secondary btn-action">
