...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        // Insert team member
        $stmt = $conn->prepare("INSERT INTO team_members (full_name, education, photo, portfolio, is_active, order_index) VALUES (?, ?, ?, ?, ?, ?)");
...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const platforms = ['LinkedIn', 'Twitter', 'Email', 'Facebook', 'Instagram', 'Other'];
