...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        // Insert team member
        $stmt = $conn->prepare("INSERT INTO team_members (full_name, education, contact, photo, portfolio, is_active, order_index) VALUES (?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("sssssii", $full_name, $education, $contact, $photo_path, $portfolio, $is_active, $order_index);
        $stmt->execute();
