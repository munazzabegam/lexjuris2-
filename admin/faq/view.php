...
if (isset($_GET['id'])) {
    ...
    if ($faq_id) {
        $stmt = $conn->prepare("SELECT f.*, a.username as author_name FROM faq f LEFT JOIN admin_users a ON f.author_id = a.id WHERE f.id = ?");
        ...
        <div class="container mt-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="faq-meta">
                        <span>Author: <?php echo htmlspecialchars($faq['author_name'] ?? 'N/A'); ?></span>
